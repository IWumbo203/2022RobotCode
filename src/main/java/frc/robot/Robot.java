...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("", m_robotContainer.m_drivetrain.m_field.getRobotObject().getPose().getX());
    SmartDashboard.putNumber("", m_robotContainer.m_drivetrain.m_field.getRobotObject().getPose().getY());
    SmartDashboard.putNumber("", m_robotContainer.m_drivetrain.m_field.getRobotObject().getPose().getRotation().getSin());
    SmartDashboard.putNumber("", m_robotContainer.m_drivetrain.m_field.getRobotObject().getPose().getRotation().getCos());
    SmartDashboard.putNumber("", m_robotContainer.m_drivetrain.m_field.getRobotObject().getPose().getRotation().getTan());
  }
